/* Generated by Cython 0.20.1 on Tue Oct  7 23:21:40 2014 */
      ...
      /*try:*/ {
        ...
        if (1 == 0) abort();
        {
            ...
            if (__pyx_t_3 > 0)
            {
                ...
                {
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_nb) firstprivate(__pyx_v_eq) lastprivate(__pyx_v_eq) lastprivate(__pyx_v_cost) lastprivate(__pyx_v_a) lastprivate(__pyx_v_b) lastprivate(__pyx_v_j) lastprivate(__pyx_v_i)
                    #endif /* _OPENMP */
      ...
      /*try:*/ {
        ...
        if (1 == 0) abort();
        {
            ...
            if (__pyx_t_3 > 0)
            {
                ...
                {
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_b) lastprivate(__pyx_v_a) lastprivate(__pyx_v_j) lastprivate(__pyx_v_nb) firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) lastprivate(__pyx_v_cost)
                    #endif /* _OPENMP */
                    for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_3; __pyx_t_2++){
                        {
      ...
      /*try:*/ {
        ...
        if (1 == 0) abort();
        {
            ...
            if (__pyx_t_3 > 0)
            {
                ...
                {
                    #ifdef _OPENMP
                    #pragma omp for firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) lastprivate(__pyx_v_nb) lastprivate(__pyx_v_site) lastprivate(__pyx_v_j)
                    #endif /* _OPENMP */
                    for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_3; __pyx_t_2++){
                        {
                            __pyx_v_i = 0 + 1 * __pyx_t_2;
